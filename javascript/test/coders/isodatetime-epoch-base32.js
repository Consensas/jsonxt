/*
 *  test/coders/isodatetime-epoch-base32.js
 *
 *  David Janes
 *  Consenas.com
 *  2021-04-01
...
describe("coders/isodatetime-epoch-base32", function() {
    before(function() {
        _util.shims_on()
    })
    ...
    for (let [ start, want ] of [
        [ "2021-03-03T22:22:51Z", "1G4031R", ],
        [ "1970-03-03T22:22:51Z", "539HR", ],
        [ "1960-03-03T22:22:51Z", "-97PVU5", ],
        [ "1900-01-01T22:22:51Z", "-21QIGU5", ],
    ]) {
