...
const rule_encode = (rule, value) => {
    switch (rule.type) {
    case "iso-epoch-base64":
        return Number(Math.round(new Date(value).getTime() / 1000)).toString(32)
    
    case "md5":
        return require("iotdb-helpers").hash.md5.base64(value)
...
exports.rule_encode = rule_encode
