...
module.exports = Object.assign(
    ...
    require("./unpack"),
    {
        encoders: {
            ...
            "string-plus": require("./encoders/string-plus").encode,
            "string-blank": require("./encoders/string-blank").encode,
        ...
        decoders: {
            ...
            "string-plus": require("./encoders/string-plus").decode,
            "string-blank": require("./encoders/string-blank").decode,
            "integer": require("./encoders/integer").decode,
            "integer-base32": require("./encoders/integer-base32").decode,

            "pathcheck-numeric": require("./encoders/pathcheck-numeric").decode,
            "pathcheck-string": require("./encoders/pathcheck-string").decode,
            "pathcheck-shortstring": require("./encoders/pathcheck-shortstring").decode,
        },
    }
)
